 ...
 */
final class Version20240915091657 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE room (id INT NOT NULL, hostel_id INT NOT NULL, room_number INT NOT NULL, capacity INT NOT NULL, number_of_bed INT NOT NULL, is_avialable BOOLEAN NOT NULL, aviability JSON NOT NULL, image VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
