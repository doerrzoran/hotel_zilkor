 ...
 */
final class Version20240530142235 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE booking (id INT NOT NULL, guest_id INT NOT NULL, room_id INT NOT NULL, arrival_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, depature_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, booking_period JSON NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE "user" (id INT NOT NULL, role_id INT NOT NULL, username VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
