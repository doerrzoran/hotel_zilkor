 ...
 */
final class Version20241007093346 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE booking (id INT NOT NULL, room_id INT NOT NULL, guest_id INT NOT NULL, arrival_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, departure_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, booking_period JSON NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, is_active BOOLEAN NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE hostel (id INT NOT NULL, manager_id INT DEFAULT NULL, location VARCHAR(255) NOT NULL, city VARCHAR(255) NOT NULL, country VARCHAR(255) NOT NULL, number_of_rooms INT NOT NULL, slug VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE room (id INT NOT NULL, hostel_id INT NOT NULL, room_number INT NOT NULL, capacity INT NOT NULL, number_of_bed INT NOT NULL, is_avialable BOOLEAN NOT NULL, aviability JSON NOT NULL, image VARCHAR(255) DEFAULT NULL, description TEXT DEFAULT NULL, price DOUBLE PRECISION NOT NULL, PRIMARY KEY(id))');
